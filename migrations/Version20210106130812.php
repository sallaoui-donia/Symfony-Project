 ...
 */
final class Version20210106130812 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE inscription_camping (inscription_id INT NOT NULL, camping_id INT NOT NULL, INDEX IDX_A878F2085DAC5993 (inscription_id), INDEX IDX_A878F2083CC6385 (camping_id), PRIMARY KEY(inscription_id, camping_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE inscription_club (inscription_id INT NOT NULL, club_id INT NOT NULL, INDEX IDX_995843C15DAC5993 (inscription_id), INDEX IDX_995843C161190A32 (club_id), PRIMARY KEY(inscription_id, club_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE inscription_event (inscription_id INT NOT NULL, event_id INT NOT NULL, INDEX IDX_69E75EEA5DAC5993 (inscription_id), INDEX IDX_69E75EEA71F7E88B (event_id), PRIMARY KEY(inscription_id, event_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE inscription_randonne (inscription_id INT NOT NULL, randonne_id INT NOT NULL, INDEX IDX_B6E51C565DAC5993 (inscription_id), INDEX IDX_B6E51C56CF1641FE (randonne_id), PRIMARY KEY(inscription_id, randonne_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
